...
<div class="events"  dir="ltr">
  ...
  <div class="container">
    <div class="info">
      <br>
      <h2 class="title"> مركز هيا للأبحاث والدراسات </h2>
      <br>
      <br>
      <br>
      <p class="description">
        مركز هيا للأبحاث والدراسات تأسس عام 2016 في قطاع غزة ، وهو مؤسسة غير ربحية، يقدم المركز خدماته في مجال البحث والتحليل الاجتماعي والاقتصادي والخدمات الانسانية وتنمية وبناء القدرات والمشورة الاستراتيجية في مجالات متعددة  واقتصادية واجتماعية على المستوى المحلي والاقليمي و يعنى المركز بتعميق مقومات البحث العلمي وإشاعة المعرفة عبر وسائل الإعلام وتكنولوجيا الاتصال بما يخدم الاستراتيجيات واستشراف المستقبل فلسطينياً وعربياً وإقليمياً ودولياً، مساهمة منها في الارتقاء بمستوى المعرفة وإغناء المشهد الثقافي والإعلامي وإثراء التفكير الاستراتيجي.
      </p>
    </div>
