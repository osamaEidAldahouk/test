    ...
    <div class="services" >
      ...
      <div class="container">
        <div class="box">
          ...
          <h3>Haya.ps.ps@gmail.com</h3>
          <div class="info">
            <a href="mailto:Haya.ps.ps@gmail.com">Gmail</a>
          </div>
        </div>
        <div class="box">
          <i class="fas fa-phone-alt fa-4x"></i>
          <h3>الهاتف</h3>
          <h3>00972597488816</h3>
          <div class="info">
            <a href="#">Phone</a>
          </div>
        </div>
        <div class="box">
          ...
          <h3>P1048486861 $ & € Account Name: Haya Center for Development and Research Payeer
          </h3><br>
          <div class="info">
            <a href="#">Bank</a>
          </div>
        ...
        <div class="box">
          <i class="fas fa-money-check-alt fa-4x"></i>
          <h3>الحسابات البنكية:</h3>
          <h3>U28996252 $ E29937468 € Account Name: Haya Center for Development and Research Perfect Money
          </h3>
          <div class="info">
            <a href="#">Bank</a>
          </div>
